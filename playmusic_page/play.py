...
# Create genres
genres = ["Rock", "Pop", "Jazz", "Classical", "Hip_Hop", "Country", "userdata"]
...
initial_image_path = "assets/tape_small.png"  # Replace with the actual path to your initial image
...
# close window when playing song
def on_close():
    if not is_playing:
        root.destroy()
