...
initial_image_path = "assets/ATape_small.png"  # Replace with the actual path to your initial image
...
def rotate_image():
    rotation_angle = 0
    image_path = "assets/ATape_small.png"  # Replace with the actual path to your image
