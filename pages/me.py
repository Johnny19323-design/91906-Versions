...
class MePage(tk.Frame):
    ...
    def create_widgets(self):
        ...
        intro_label = tk.Label(self, text="Important notice while using the app", font=("Arial", 18, "underline"))
